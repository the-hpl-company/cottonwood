...
On the streaming side, the fraud is equally brazen. An estimated 3-10% of Spotify's total streams are artificial, driven by bot networks and click farms. Over 100,000 AI-generated tracks were uploaded to Spotify in 2023 -- fake artists using shell identities and playlist manipulation to siphon royalties from legitimate creators. Spotify withheld $1.5 billion in royalties from 2020-2022 for suspected fraud. The music industry loses roughly $300 million annually to streaming fraud. The surveillance apparatus that people worry about cannot even distinguish a human listener from a bot.
...
Incrementality testing -- the gold standard -- has revealed that over 40% of paid search traffic is non-incremental, meaning users would have converted anyway. Google and Meta's native dashboards default to last-touch attribution, which systematically inflates ROAS for their own ads. The platforms grade their own homework, and the grade is always an A.
...
The adblocker industry illustrates this perfectly. Adblock Plus (Eyeo) charges advertisers $10,000-$100,000 per year for allowlist access, generating 50-70% of its revenue from this gatekeeping function. Adblocking cost publishers $35 billion in lost revenue in 2022. The tool that promises to protect users from advertising is itself an advertising business -- one that charges a toll for the privilege of reaching the people it claims to protect. It is an ad-tech protection racket with a privacy label.
...
Loyalty card programs at Kroger, Safeway, and Walmart collect item-level purchase data and sell aggregated insights. Loyalty program members spend 18-25% more per transaction. Rewards programs harvest consumer data worth $500-1,000 per year per user while returning only $50-100 per year in rewards -- a 5-10x asymmetry. This is the closest thing to "they know what you buy" -- and it is a grocery store loyalty card, not an AI system.

And the loyalty programs are not just data collection mechanisms. They are financial instruments. Unredeemed loyalty points represent $48 billion in industry-wide liabilities. Starbucks reported $210 million in breakage income in 2023 from unredeemed rewards alone -- pure profit from promises never kept. American Airlines' mile liabilities ($7.2 billion) exceed its liquid assets ($6.7 billion). Air Canada securitized its Aeroplan program into bonds -- mileage-backed securities, trading on the faith that most people will never redeem what they have been promised. Most major airlines are, functionally, banks that happen to operate aircraft. Their loyalty programs face no FDIC-style protections, no reserve requirements. If a social media panic triggered mass redemptions, the resulting run would look like a bank failure -- because it would be one.
...
- We have only lightly touched on the reality that even enterprises cannot handle data at this scale. The industry invented the concept of the "data lake" -- quite literally throwing everything into a heap (Heap is, unironically, a real product name) and using a tool to find the Snowflakes (also, unironically, a real product name). Enterprises lose $200 billion annually due to poor data usability. 60% of data lake projects fail due to "data swamp" conditions. 70% of enterprises exceed their cloud data lake budgets. Only 30% of data collected is ever used for analytics. The distance between "we have all the data" and "we can use any of it" is the actual state of enterprise data infrastructure.
...
- WCAG (Web Content Accessibility Guidelines) compliance illustrates both the ambiguity of digital standards and the asymmetric burden they create. 96.3% of the top 1 million websites have detectable WCAG failures. Big tech companies routinely fail basic accessibility requirements -- and can absorb the legal risk. Small businesses, particularly disabled-owned businesses, face the same compliance standards with a fraction of the resources. WCAG 2.1 AA compliance costs small businesses $5,000-$50,000 (0.5-5% of revenue) versus Fortune 500 companies' $200,000-$2,000,000+ (0.0004-0.004% of revenue) -- a regressive burden. Disabled-owned businesses lose $6.9 billion annually in the U.S. due to inaccessible platform technology they cannot control. 60% of disabled entrepreneurs abandoned platforms like Squarespace due to inaccessible templates. 4,000+ digital accessibility lawsuits were filed in 2023, with no explicit WCAG mandate under ADA. The people most harmed by this ambiguity are the people the ADA was designed to protect.
